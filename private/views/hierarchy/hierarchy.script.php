          ...
          $.each(pastor, function(index, pastorInfo){
            ...
            dataPastor += "<li class='list-group-item'>"+
                              "<div class='item-content'>"+
                                ...
                                "<a href='<?=ROOT_PUBLIC?>/profilelist/"+pastorInfo.id+"'><span class='item-text link-name'>"+lvltwofullname+"</span></a>"+
                              "</div>"+
                            "</li>";
          });
        }
        ...
        if(allelderLength > 0){
          $.each(elder, function(index, elderInfo){
            ...
            dataElder += "<li class='list-group-item'>"+
                              "<div class='item-content'>"+
                                "<img src='"+memPPicture+"' alt='Image' class='item-image'>"+
                                "<a href='<?=ROOT_PUBLIC?>/profilelist/"+elderInfo.id+"'><span class='item-text link-name'>"+lvltwofullname+"</span></a>"+
                              "</div>"+
                            "</li>";
          });
        }
        ...
        if(alldeaconLength > 0){
          $.each(deacon, function(index, deaconInfo){
            ...
            dataDeacon += "<li class='list-group-item'>"+
                              "<div class='item-content'>"+
                                "<img src='"+memPPicture+"' alt='Image' class='item-image'>"+
                                "<a href='<?=ROOT_PUBLIC?>/profilelist/"+deaconInfo.id+"'><span class='item-text link-name'>"+lvltwofullname+"</span></a>"+
                              "</div>"+
                            "</li>";
          });
        }
